...
def ventana_datos(width=None, height=None):
    ...
    def saltar_a_button_entrar(event):
        button_entrar.focus()
    ...
    entry_8.bind("<Return>", saltar_a_button_entrar)
    ...
    button_entrar.bind("<Return>", ejecutar_boton)
...
# label_23: Revision
label_23 = tk.Label(frame, text="ELRAD Electronics México Rev1.1",
                    fg="black", bg="white")
