# Rev1.0:
# Creación de aplicación para validar el ID de las piezas y verificar que corresponden al numero de parte a programar, el programa
# valida los primeros 6 digitos del ID que corresponden al numero de parte ELRAD, ademas de lee el puerto UART del programador
# para llevar el registro de la validación del ID y el resultado de la programación.
# Rev1.1:
# Saltos en ventana de datos al escribir y presionar enter.
# Rev1.2:
# Escaneo de número de empleado y orden de producción
# ---------------------------------------------------------------------------------------------------------------------
...
def ventana_datos(width=None, height=None):
    ...
    def saltar_a_entry_8(event):
        entry_8.focus()

    def ejecutar_boton(event=None):
        button_entrar.invoke()
    ...
    # ---------------Framedat Row0
    label_18 = tk.Label(framedat, text="Escanear número de empleado:",
                        fg="black", bg="#D9D9D9")
    label_18.config(font=("Arial", 20, "bold"))
    ...
    entry_7 = tk.Entry(framedat, width=15, justify="center", fg="#0A0A09", bg="#A6A6A6",
                       border=3)
    entry_7.config(font=("Arial", 20, "bold"))
    entry_7.grid(row=0, column=1, padx=10, pady=20, sticky="nsew")
    entry_7.focus()
    entry_7.bind("<Return>", saltar_a_entry_8)

    # ---------------Framedat Row1
    label_19 = tk.Label(framedat, text="Escanear orden de producción:",
                        fg="black", bg="#D9D9D9")
    label_19.config(font=("Arial", 20, "bold"))
    ...
    entry_8 = tk.Entry(framedat, width=15, justify="center", fg="#0A0A09", bg="#A6A6A6",
                       border=3)
    entry_8.config(font=("Arial", 20, "bold"))
    entry_8.grid(row=1, column=1, padx=10, pady=20, sticky="nsew")
    entry_8.bind("<Return>", aceptar)
...
# label_23: Revision
label_23 = tk.Label(frame, text="ELRAD Electronics México Rev1.2",
                    fg="black", bg="white")
